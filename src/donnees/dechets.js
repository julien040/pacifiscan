export default {
  ...
  "Balai d'essuie-glace": {
    ...
    matiere: ["Caoutchouc", "Plastique", "Métal"],
    queFaire:
  ...
  "Café (marc)": {
    ...
    matiere: ["Organique"],
    queFaire:
      "Compostez-le à domicile ou jetez-le dans un bac de compostage partagé, si cette solution a été mise en place à proximité de votre domicile. Sinon, jetez-le dans la poubelle des ordures ménagères.",
    commentEviter:
      "Comme beaucoup de résidus alimentaires (épluchures, coquilles d'oeufs, filtres en papier, pain, laitages, croûtes de fromages, fanes de légumes, fruits et légumes abîmés, etc.), le marc de café peut être valorisé par compostage. Faire votre compost vous permettra d'obtenir un amendement naturel pour votre jardin ou vos plantes en pots.",
    icone: "https://img.icons8.com/color/96/000000/waste--v1.png",
    ouDeposer: null,
  ...
  Canapé: {
    nom: "Canapé",
    matiere: ["Bois", "Cuir", "Tissu"],
    queFaire:
      "S'il est encore en bon état, remettez-le à une structure de réemploi ou revendez-le.<br /><br />S'il n'est plus utilisable, rapportez-le à un point de collecte : en déchèterie ou chez les distributeurs volontaires. Vous pouvez aussi le faire reprendre à la livraison d'un meuble neuf.<br /><br />",
    commentEviter: null,
    icone: "https://img.icons8.com/color/96/000000/waste--v1.png",
    ouDeposer: ["rec81BUGYJYXAfLid", "recOkqmNZoMeqSRgy"],
    collecte: null,
  },
  Canette: {
    nom: "Canette",
  ...
  "Crayon en bois": {
    ...
    queFaire: "Jetez-le dans la poubelle des ordures ménagères.",
    commentEviter:
      "Préférez l'achat d'instruments d'écriture porteur d'un logo environnemental public. Le logo environnemental Écolabel Nordique (Nordic Swan) garantit que le produit à un moindre impact environnemental tout au long de son cycle de vie. Il garantit notamment l'obligation d'avoir au moins 50 % du bois utilisé annuellement provenant de forêts gérées durablement et certifiés, l'interdiction d'utiliser du plomb, du mercure, du cadmium ou du chrome hexavalent dans le corps du stylo et l'ensemble de ses pièces, etc.",
    icone: "https://img.icons8.com/color/96/000000/waste--v1.png",
    ouDeposer: null,
    collecte: ["recfH4zozLt2dY5Xc"],
  },
  ...
  Feutre: {
    ...
    queFaire: "Jetez-le dans la poubelle des ordures ménagères",
    commentEviter:
      "Pour conserver vos marqueurs (pour tableaux blancs) plus longtemps, posez-les à l'horizontal. Préférez des produits portant un logo environnemental. Par exemple, l'écolabel public \"Nordic Swan\" vous garantit l'utilisation de matière recyclée ou renouvelable dans le produit.",
    icone: "https://img.icons8.com/color/96/000000/waste--v1.png",
    ouDeposer: null,
    collecte: ["recfH4zozLt2dY5Xc"],
  },
  ...
  "Micro-ondes": {
    ...
    matiere: ["Electronique", "Métal"],
    queFaire:
      "S'il est encore en bon état, donnez-le à une structure de réemploi ou revendez-le. Sinon faites le réparer ou apportez-le en déchèterie.",
    commentEviter:
      "Prolongez la vie de votre produit en vous assurant dès l'achat qu'il bénéficie d'une bonne garantie réparation et entretenez-le régulièrement. Privilégiez un micro-ondes démontable, donc plus facile à réparer, pour faire face à une éventuelle panne après expiration de la garantie et faites durer autant que possible votre équipement.",
    icone: "https://img.icons8.com/color/96/000000/waste--v1.png",
    ouDeposer: ["recF9aJRo8K0v740b", "recSnMXSFlp0nPJtc"],
    collecte: null,
  },
  ...
  Réfrigérateur: {
    ...
    queFaire:
      "S'il est encore en bon état, donnez-le à une structure de réemploi ou revendez-le. Sinon faites-le réparer ou apportez-le en déchèterie.",
    commentEviter:
      "Prolongez la vie de votre produit en vous assurant dès l'achat qu'il bénéficie d'une bonne garantie réparation et entretenez-le régulièrement. Faites enfin durer autant que possible votre équipement.",
    icone: "https://img.icons8.com/color/96/000000/waste--v1.png",
    ouDeposer: ["recSnMXSFlp0nPJtc"],
    collecte: null,
  },
  "Sac en coton (tissu)": {
